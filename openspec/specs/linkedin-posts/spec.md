...
A LinkedIn post is a single record derived from a script, managed as a singular
nested resource (no collection), with a show page that links onward to the
dashboard and new-idea creation.
